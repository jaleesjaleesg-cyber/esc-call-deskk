...
def compile_database(quiet=False):
    """Compiles intelligence database from all cases, Word report dossiers, and registry."""
    ...
    # If pipeline_state.json does not exist yet, write initial state
